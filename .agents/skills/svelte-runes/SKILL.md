---
name: svelte-runes
# IMPORTANT: Keep description on ONE line for Codex compatibility
# prettier-ignore
...
3. Run: Codex-skills-cli validate <path>
4. If multi-line description warning: run Codex-skills-cli doctor <path>
